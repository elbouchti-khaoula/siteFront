...
export class AuthSignUpComponent implements OnInit
{
    ...
    */
    ...
    {   
        ...
        this._authService.checkUserProd(this.signUpForm.value).subscribe(
            response => {
    ...
    sendSms(): void
    {
        ...
        this._authService.sendSms(code,this.signUpForm3.get('num').value).subscribe(
            response => {
    ...
    activerCompte(): void
    {
        ...
        if(localStorage.getItem('code') == this.signUpForm4.get('code').value){
            ...
            let user = {
                ...
                pass1:  this.signUpForm4.get('pass1').value,
                agreements: null
            }
